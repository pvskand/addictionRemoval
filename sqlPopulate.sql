...
-- -----------------------------------------------------
-- Data for table `addictionRemoval`.`Report`
-- -----------------------------------------------------
START TRANSACTION;
USE `addictionRemoval`;
INSERT INTO `addictionRemoval`.`Report` (`reportid`, `type`, `email`, `Member_email`, `Description`) VALUES (1, 'communication abuse', 'doc1@gmail.com', 'user2@gmail.com', 'He was using abusive language');
...
-- -----------------------------------------------------
-- Data for table `addictionRemoval`.`Case`
-- -----------------------------------------------------
START TRANSACTION;
USE `addictionRemoval`;
INSERT INTO `addictionRemoval`.`Case` (`isCompleted`, `caseid`, `counsellor_email`, `patient_email`, `startDate`, `endDate`, `Addictions_addictionName`) VALUES (0, 1, 'doc1@gmail.com', 'user2@gmail.com', '2017-10-30 13:15:16.000000', '2000-01-01 00:00:01', 'smoking');
INSERT INTO `addictionRemoval`.`Case` (`isCompleted`, `caseid`, `counsellor_email`, `patient_email`, `startDate`, `endDate`, `Addictions_addictionName`) VALUES (0, 2, 'doc2@gmail.com', 'user1@gmail.com', '2017-10-30 13:14:16.000000', '2000-01-01 00:00:01', 'drinking');
